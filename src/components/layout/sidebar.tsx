...
export function Sidebar() {
  ...
  return (
    ...
    >
        ...
        {logoUrl ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-none">
              <span
                className="text-base font-semibold tracking-[0.12em] uppercase"
                style={{ color: "var(--sidebar-foreground)", letterSpacing: "0.14em" }}
              >
                Volare
              </span>
              <span
                className="text-[9px] tracking-[0.22em] uppercase mt-0.5"
                style={{ color: "var(--sidebar-muted, #c4a0ae)" }}
              >
                Acessórios
              </span>
            </div>
      ...
      {/* Divider */}
      <div className="mx-3 mb-4 h-px" style={{ backgroundColor: "var(--sidebar-border)" }} />
